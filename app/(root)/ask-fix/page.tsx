...
const Page = () => {
  ...
  const loadMoreRef = useRef<HTMLDivElement | null>(null); // Tham chiếu đến div dùng cho việc cuộn
  ...
  const fetchPosts = async () => {
    ...
    if (data) {
      setPosts((prevPosts) => [...prevPosts, ...data.posts]); // Duy trì các bài đăng cũ và thêm mới
      setTotal(data.total);
    }
  ...
  return (
    <PageContainer>
      <div className="flex justify-between items-center">
        ...
        <Button title="Add Post" size="small" />
      </div>
